...
class TrackingAndFocus:
    def __init__(self, source, device, model) -> None:
        self.drone = MAVSDKAutoControl('/dev/usb0/')
        self.device = device 
    ...
    def arm_drone(self):
        self.drone.connect_pixhawk()
        self.drone.start_offboad_mode()
...
if __name__== "__main__":
    object_auto_control = TrackingAndFocus()
    object_auto_control.arm_drone()
    object_auto_control.processing_source()
